    ...
    translation: {
      ...
      auth: {
        ...
        tips: {
          ...
          change4: 'เพื่อรีเช็ทรหัสผ่าน, กรุณากดปุ่ม BOOT บนอุปกรณ์ MSPKVM ค้างไว้.'
        }
      },
      wifi: {
        title: 'Wi-Fi',
        description: 'ตั้งค้า Wi-Fi สำหรับ MSPKVM',
        success: 'กรุณาตรวจสอบสถานะเครื่องข่ายของ MSPKVM และไปที่ IP address ใหม่',
      ...
      mouse: {
        ...
        hidOnly: {
          title: 'โหมด HID-Only',
          desc: 'หากเมาส์และคีย์บอร์ดของคุณหยุดตอบสนองและการรีเซ็ต HID ไม่ช่วย อาจเป็นปัญหาความเข้ากันได้ระหว่าง MSPKVM และอุปกรณ์ ลองเปิดโหมด HID-Only เพื่อความเข้ากันได้ที่ดีขึ้น',
          tip1: 'การเปิดโหมด HID-Only จะปิดการทำงานดิสก์จำลองและ NIC จำลอง',
          tip2: 'ในโหมด HID-Only ดิสก์จะลองจะถูกปิดใช้งาน',
          tip3: 'MSPKVM จะรีบูตอัตโนมัติหลังจากเปลี่ยนโหมด',
      ...
      image: {
        ...
        tips: {
            ...
            usb1: 'เชื่อมต่อ MSPKVM กับคอมพิวเตอร์ของคุณผ่าน USB',
            ...
            scp1: 'ตรวจสอบให้แน่ใจว่า MSPKVM และคอมพิวเตอร์ของคุณอยู่ในเครือข่ายเดียวกัน',
            scp2: 'เปิดเทอร์มินัลบนคอมพิวเตอร์ของคุณและใช้คำสั่ง SCP เพื่ออัปโหลดไฟล์อิมเมจไปยังไดเรกทอรี /data บน MSPKVM',
            scp3: 'ตัวอย่าง: scp <ที่อยู่ของไฟล์> root@<ip อุปกรณ์>:/data',
            tfCard: 'การ์ด TF',
            tf1: 'วิธีนี้รองรับแค่บนระบบปฏิบัติการ Linux',
            tf2: 'นำการ์ด TF ออกจาก MSPKVM',
            tf3: 'ใส่การ์ด TF ลงในเครื่องอ่านการ์ดและเชื่อมต่อกับคอมพิวเตอร์ของคุณ',
            tf4: 'คัดลอกไฟล์อิมเมจไปยังไดเรกทอรี /data บนการ์ด TF',
            tf5: 'ใส่การ์ด TF กลับเข้า MSPKVM'
        }
      },
      script: {
        title: 'สคริปต์',
      ...
      settings: {
        title: 'การตั้งค่า',
        about: {
          title: 'เกี๋ยวกับ MSPKVM',
          information: 'ข้อมูล',
          ip: 'IP',
          mdns: 'mDNS',
          application: 'เวอร์ชั่นแอปพิเคชั่น',
          applicationTip: 'เวอร์ชั่นเว็บ MSPKVM',
          image: 'เวอร์ชั่น Image ระบบ',
          imageTip: 'เวอร์ชั่น Image ระบบ MSPKVM',
        ...
        tailscale: {
          ...
          unzip: 'และแตกไฟล์',
          upTailscale: 'อัปโหลด tailscale ไปยังไดเรกทอรี /usr/bin/ ของ MSPKVM',
          upTailscaled: 'อัปโหลด tailscaled ไปยังไดเรกทอรี /usr/sbin/ ของ MSPKVM',
