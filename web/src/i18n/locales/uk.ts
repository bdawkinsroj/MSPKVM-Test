const uk = {
  translation: {
    ...
    auth: {
      ...
      tips: {
        reset1:
          'Щоб скинути паролі, натискаючи та тримаючи кнопку завантаження на MSPKVM протягом 10 секунд.',
        ...
        change4: 'Щоб скинути паролі, натисніть та утримуйте кнопку "Завантаження" на MSPKVM.'
      }
    },
    wifi: {
      title: 'Wi-Fi',
      description: 'Налаштування Wi-Fi для MSPKVM',
      success: 'Будь ласка, перевірте статус мережі MSPKVM та відвідайте нову IP -адресу.',
    ...
    mouse: {
      ...
      hidOnly: {
        ...
        desc: 'Якщо ваша миша та клавіатура перестають відповідати та скинути HID, це не допомагає, це може бути проблемою сумісності між MSPKVM та пристроєм. Спробуйте ввімкнути режим "лише HID" лише для кращої сумісності.',
        ...
        tip3: 'MSPKVM автоматично перезавантажиться після перемикання режимів',
    ...
    image: {
      ...
      tips: {
        ...
        usb1: "Під'єднайте MSPKVM до вашого комп'ютера через USB.",
        ...
        scp1: "Переконайтеся, що MSPKVM і ваш комп'ютер знаходяться в одній локальній мережі.",
        scp2: "Відкрийте термінал на вашому комп'ютері та використовуйте команду SCP для завантаження файлу зображення до каталогу /data на MSPKVM.",
        scp3: 'Приклад: scp ваш-шлях-до-зображення root@ваш-ip-mspkvm:/data',
        tfCard: 'TF карта',
        tf1: 'Цей метод підтримується на системах Linux',
        tf2: 'Отримайте TF карту з MSPKVM (для повної версії, спочатку розберіть корпус).',
    ...
    settings: {
      ...
      about: {
        ...
        applicationTip: 'Версія веб-додатка MSPKVM',
        image: 'Версія образу',
        imageTip: 'Версія системного іміджу MSPKVM',
      ...
      device: {
        ...
        rebootDesc: 'Ви впевнені, що хочете перезавантажити MSPKVM?',
        okBtn: 'Так',
        cancelBtn: 'Ні'
      },
      tailscale: {
        ...
        upTailscale: 'Завантажте Tailscale до каталогу /usr/bin/ на MSPKVM',
        upTailscaled: 'Завантажте Tailscaled до каталогу /usr/sbin/ на MSPKVM',
