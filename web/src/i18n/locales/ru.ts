const ru = {
  translation: {
    ...
    auth: {
      ...
      tips: {
        reset1:
          'Чтобы сбросить пароли, нажмите и удерживайте кнопку BOOT на MSPKVM в течении 10 секунд.',
        ...
        change4: 'Чтобы сбросить пароли, нажмите и удерживайте кнопку BOOT на MSPKVM.'
      }
    },
    wifi: {
      title: 'Wi-Fi',
      description: 'Настройка Wi-Fi для MSPKVM',
      success: 'Пожалуйста, проверьте сетевой статус MSPKVM и откройте в браузере новый IP адрес.',
    ...
    mouse: {
      ...
      hidOnly: {
        ...
        desc: 'Если мышь и клавиатура перестали отвечать, и перезагрузка HID-подсистемы не помогает, это может быть связано с несовместимостью между MSPKVM и устройством. Попробуйте включить режим только HID для улучшения совместимости.',
        ...
        tip3: 'MSPKVM автоматически перезагрузится после переключения режима',
    ...
    image: {
      ...
      tips: {
        title: 'Как загрузить',
        usb1: 'Подключите MSPKVM к вашему компьютеру через USB.',
        ...
        scp1: 'Убедитесь что MSPKVM и ваш компьютер находятся в одной и той же сети.',
        scp2: 'Откройте терминал на вашем компьютере и используйте команду scp, чтобы загрузить файл образа в директорию /data, находящуюся на MSPKVM.',
        scp3: 'Например: scp путь-к-образу root@ip-вашего-mspkvm:/data',
        tfCard: 'Карта памяти',
        tf1: 'Этот метод поддерживается на Linux-системах',
        tf2: 'Извлеките карту памяти из MSPKVM (если у вас "полная" (Full) версия, сначала нужно разобрать корпус).',
        ...
        tf5: 'Вставьте карту памяти в MSPKVM.'
      }
    },
    script: {
      title: 'Скрипты',
    ...
    settings: {
      title: 'Настройки',
      about: {
        title: 'О системе MSPKVM',
        information: 'Информация',
        ip: 'IP-адрес',
        mdns: 'Доменное имя mDNS',
        application: 'Версия ПО',
        applicationTip: 'Версия веб-программы MSPKVM',
        image: 'Версия прошивки',
        imageTip: 'Версия системного образа MSPKVM',
        deviceKey: 'Ключ устройства',
        community: 'Сообщество',
        hostname: 'Имя хоста',
        hostnameUpdated: 'Имя хоста изменено. Перезагрузите MSPKVM, чтобы настройки вступили в силу.',
        ipType: {
          'Wired': 'Проводное',
      ...
      device: {
        ...
        reboot: 'Перезагрузка',
        rebootDesc: 'Вы уверены, что хотите перезагрузить MSPKVM?',
        okBtn: 'Да',
        cancelBtn: 'Нет'
      },
      tailscale: {
        ...
        upTailscale: 'Переместите tailscale в каталог /usr/bin/ на MSPKVM',
        upTailscaled: 'Переместите tailscaled в каталог /usr/sbin/ на MSPKVM',
